...
namespace Crypto.EskmsAPI_UnitTest
{
    ...
    public class iBonAuthenticate_UnitTest //: TraceListener
    {
        ...
        private IList<iBonAuthenticate> AuthObjList { get; set; }
        ...
        public void Init()
        {
            ...
            this.iBonAuth.Input_BlobValue = this.hexConverter.Hex2Bytes("0104873ABA8D2C80494341534804873ABA8D2C80494341534804873ABA8D2C80");/*"0104214C82583B80494341534804214C82583B80494341534804214C82583B80");*///"0104873ABA8D2C80494341534804873A9B330A45CCB51DDE66FDD7EABD400895");//
